...
class Kiosk(Base):
    ...
    fk_addressid: Mapped[Optional[int]] = mapped_column("FK_ADDRESSID", ForeignKey("ADDRESS.ID"),
                                                        index=True)
    fk_kiosk_familyid: Mapped[Optional[int]] = mapped_column("FK_KIOSK_FAMILYID",
...
class KioskOperatorLog(Base):
    ...
    fk_kioskid: Mapped[Optional[int]] = mapped_column("FK_KIOSKID", Integer, ForeignKey("KIOSK.ID"),
                                                      index=True)
    fk_permission_number: Mapped[Optional[int]] = mapped_column("FK_PERMISSION_NUMBER",
